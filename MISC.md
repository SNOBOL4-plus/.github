...
SNOBOL4 and Icon share a bloodline — Griswold invented both. The Byrd Box IR built for SNOBOL4ever is the bridge. Same four ports. Same `byrd_ir.py`. New Icon frontend feeding the same pipeline. One week built SNOBOL4-everywhere. The clock starts the moment `beauty.sno` compiles itself.
