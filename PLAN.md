...
| **⭐ Scrip Demo** | SD-16: M-SD-DEMO6 ✅ — demo6/sieve.md; ARRAY-bitset/list-every/trial-div-recursion | `72de264` SD-16 | M-SD-DEMO7 |
...
`M-SD-DEMO1` ✅ · `M-SD-DEMO2` ✅ · `M-SD-DEMO3` ✅ · `M-SD-DEMO4` ✅ · `M-SD-DEMO5` ✅ · `M-SD-DEMO6` ✅ · `M-SD-DEMO7` ❌ **NEXT** (caesar) · `M-SD-DEMO8` ❌ (sort) · `M-SD-DEMO9` ❌ (rpn) · `M-SD-DEMO10` ❌ (anagram)
