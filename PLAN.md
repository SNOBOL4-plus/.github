...
| **⭐ Scrip Demo** | SD-11: M-SD-DEMO1 ✅ — demo1/hello.scrip + run_demo.sh + scrip_split.py; swipl PASS; snobol4/icont SKIP (binaries absent) | `fcbd6a8` SD-11 | M-SD-DEMO2 |
...
`M-SD-DEMO1` ✅ · `M-SD-DEMO2` ❌ **NEXT** (wordcount) · `M-SD-DEMO3` ❌ (roman) · `M-SD-DEMO4` ❌ (palindrome) · `M-SD-DEMO5` ❌ (fib) · `M-SD-DEMO6` ❌ (sieve) · `M-SD-DEMO7` ❌ (caesar) · `M-SD-DEMO8` ❌ (sort) · `M-SD-DEMO9` ❌ (rpn) · `M-SD-DEMO10` ❌ (anagram)
