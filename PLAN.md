...
|---------|--------|------|----------------|
| **TINY backend** | `asm-backend` B-216 — M-EMITTER-NAMING ⚠ WIP: source prefix strip done all 4 backends; JVM+NET generated labels still need α/β/γ/ω | `646e7dd` B-216 | M-EMITTER-NAMING |
