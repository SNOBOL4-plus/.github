...
| **⭐ Scrip Demo** | SD-19: M-SD-DEMO9 ✅ — demo9/rpn.md; LINK-stack/list-stack/explicit-stack-arg | `2e3aaba` SD-19 | M-SD-DEMO10 |
...
`M-SD-DEMO1` ✅ · `M-SD-DEMO2` ✅ · `M-SD-DEMO3` ✅ · `M-SD-DEMO4` ✅ · `M-SD-DEMO5` ✅ · `M-SD-DEMO6` ✅ · `M-SD-DEMO7` ✅ · `M-SD-DEMO8` ✅ · `M-SD-DEMO9` ✅ · `M-SD-DEMO10` ❌ **NEXT** (anagram)
