...
|---------|--------|------|----------------|
| **TINY backend** | `asm-backend` B-235 — monitor-ipc | `080a834` B-235 | M-MONITOR-IPC-5WAY |
...
| **M-README-JVM-VERIFIED** | snobol4jvm README verified against Clojure source; every claim confirmed | snobol4jvm | ✅ `08d5752` README-4 |
