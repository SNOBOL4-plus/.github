...
| **ICON frontend** | `main` I-1 — M-ICON-LEX ✅ `d1697ac`: icon_lex.c + icon_lex_test.c; 103/103 PASS; all keywords, operators, literals, radix ints, # comments, no auto-semicolon, peek API | `d1697ac` | M-ICON-PARSE-LIT |
