...
| **⭐ Scrip Demo** | SD-15: M-SD-DEMO5 ✅ — demo5/fib.md; goto-loop/suspend-generator/accumulator-rule | `f7153ce` SD-15 | M-SD-DEMO6 |
...
`M-SD-DEMO1` ✅ · `M-SD-DEMO2` ✅ · `M-SD-DEMO3` ✅ · `M-SD-DEMO4` ✅ · `M-SD-DEMO5` ✅ · `M-SD-DEMO6` ❌ **NEXT** (sieve) · `M-SD-DEMO7` ❌ (caesar) · `M-SD-DEMO8` ❌ (sort) · `M-SD-DEMO9` ❌ (rpn) · `M-SD-DEMO10` ❌ (anagram)
