...
| **⭐ Scrip Demo** | SD-14: M-SD-DEMO4 ✅ — demo4/palindrome.md; IDENT(S,REVERSE(S))/subscript-walk/reverse/2 | `62b0077` SD-14 | M-SD-DEMO5 |
...
`M-SD-DEMO1` ✅ · `M-SD-DEMO2` ✅ · `M-SD-DEMO3` ✅ · `M-SD-DEMO4` ✅ · `M-SD-DEMO5` ❌ **NEXT** (fib) · `M-SD-DEMO6` ❌ (sieve) · `M-SD-DEMO7` ❌ (caesar) · `M-SD-DEMO8` ❌ (sort) · `M-SD-DEMO9` ❌ (rpn) · `M-SD-DEMO10` ❌ (anagram)
