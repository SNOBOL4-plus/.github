...
| **⭐ Scrip Demo** | SD-18: M-SD-DEMO8 ✅ — demo8/sort.md; Gimpel-BSORT/isort/msort | `62da781` SD-18 | M-SD-DEMO9 |
...
`M-SD-DEMO1` ✅ · `M-SD-DEMO2` ✅ · `M-SD-DEMO3` ✅ · `M-SD-DEMO4` ✅ · `M-SD-DEMO5` ✅ · `M-SD-DEMO6` ✅ · `M-SD-DEMO7` ✅ · `M-SD-DEMO8` ✅ · `M-SD-DEMO9` ❌ **NEXT** (rpn) · `M-SD-DEMO10` ❌ (anagram)
