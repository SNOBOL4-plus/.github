...
| **TINY HEAD** | `48a67b3` session169: SEP_W 80→120; 120-char separators; 12689 lines; 106/106 26/26 |
| **TINY next** | CONC2_SV fast path (QLIT+VART — dominant shape ~300 sites); then CONC2_VN/CONC2_VV |
